          ...
          <div className="px-4">
            ...
            <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
              {services.map((service) => (
                <div key={service.number} className="item h-full">
                  <div className="group relative block h-full">
                    <div className="relative block">
                      <div className="relative z-[1] block overflow-hidden rounded-tl-[20px]">
                        ...
                        <img
                          src={service.image}
                          alt={service.title}
                          className="block w-full scale-105 rounded-tl-[20px] transition duration-500 ease-[ease] group-hover:scale-100"
                        />
                      </div>
                    ...
                    <div className="relative mt-[-100px] block rounded-bl-[20px] rounded-br-[20px] bg-white px-5 pb-6 pt-[120px] shadow-[0px_10px_60px_0px_rgba(0,0,0,0.07)] xl:px-5">
                      <div className="font-poppins absolute left-5 top-[45px] text-[50px] font-bold leading-[0.8] text-transparent [-webkit-text-stroke:1px_#062f3a]">
                        {service.number}
                      </div>
