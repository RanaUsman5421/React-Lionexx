...
const Contact = () => {
  return (
    ...
    >
      <section className="relative block px-0 py-20 md:py-[100px] md:pb-[80px]">
        <div className="mx-auto max-w-[1320px] px-[15px]">
          <div className="grid grid-cols-1 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
            {contactCards.map((card) => (
              <div key={card.label}>
                <div className="group relative mb-[30px] block rounded-[6px] bg-[#f2f3f5] px-[15px] pb-[41px] pt-10 text-center sm:px-[25px] md:px-5 xl:px-10">
